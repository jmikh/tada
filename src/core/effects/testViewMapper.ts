...
function runTests() {
    console.log("Starting ViewMapper Tests...\n");
    ...
    // Case 1: Exact Match (1:1)
    {
        ...
        assert(mapper.contentRect.x === 0, "X should be 0");
        assert(mapper.contentRect.y === 0, "Y should be 0");
        assert(mapper.contentRect.width === 1000, "Width should be 1000");
        assert(mapper.contentRect.height === 1000, "Height should be 1000");
    ...
    // Projected Height = 1000 / 2 = 500.
    {
        ...
        assert(mapper2.contentRect.x === 0, "Case 2: X 0");
        assert(mapper2.contentRect.y === 250, "Case 2: Y 250");
        assert(mapper2.contentRect.width === 1000, "Case 2: Width 1000");
        assert(mapper2.contentRect.height === 500, "Case 2: Height 500");
    }
    ...
    // 1000 * 0.8 = 800 available.
    {
        ...
        // x = (1000 - 800) / 2 = 100.
        assert(mapper3.contentRect.x === 100, "Case 3: X 100");
        assert(mapper3.contentRect.y === 100, "Case 3: Y 100");
        assert(mapper3.contentRect.width === 800, "Case 3: Width 800");
    }
